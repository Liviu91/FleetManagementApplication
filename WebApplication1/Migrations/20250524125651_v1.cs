        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EngineCoolantTemperature = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FuelLevel = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    BatteryVoltage = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Timestamp = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CarDatas_Routes_RouteId",
                        column: x => x.RouteId,
